			...
			<div class="row">
				...
				<div class="col-xs-12 col-md-8">
					<div class="iphone-price-tag">
						...
						<img src="http://wetestproducts.com/uk.png"/>
					</div>
						...
						<div class="form-content col-xs-12">
							...
							<div class="accept-terms">
								<div class="form-bottom">
									<div class="checkbox">
										<label><input type="checkbox" name="cgu" class="checkname" value="1" required="required" checked="checked"> I Accept  <a href="http://wetestproducts.com/iphone6s/uk/terms.php" target="_BLANK">Terms & Conditions</a></label>
									</div>
								</div>
							</div>
							</div>
		...
		function apiRun(form){
			...
			$.ajax({
				...
				success: function(resp){
					if(resp){
						window.location.href="http://wetestproducts.com/iphone6s/uk?confirm";
					}else{
		...
		function apiRun(form){
			...
			$.ajax({
				...
				success: function(resp){
					console.log(resp);
					if(resp.status){
						window.location.href="http://aptrk1.com/?a=415&oc=3039&c=8408&m=3&s1=";
