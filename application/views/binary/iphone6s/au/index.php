						...
						<div class="form-content col-xs-12">
							...
							<div class="accept-terms">
								<div class="form-bottom">
									<div class="checkbox">
										<label><input type="checkbox" name="cgu" class="checkname" value="1" required="required" checked="checked"> I Accept  <a href="http://wetestproducts.com/iphone6s/au/terms.php" target="_BLANK">Terms & Conditions</a></label>
									</div>
								</div>
							</div>
							</div>
		...
		function apiRun(form){
			...
			$.ajax({
				...
				success: function(resp){
					...
					if(resp){
						window.location.href="http://wetestproducts.com/iphone6s/au?confirm";
					}else{
