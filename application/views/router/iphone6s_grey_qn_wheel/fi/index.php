...
<link href='https://fonts.googleapis.com/css?family=Open+Sans:400,600,700' rel='stylesheet' type='text/css'>	
	...
	<link rel="stylesheet" href="//landing.quizawards.com/assets/lucky_wheel_qn/css/style.css?v=1449487455">
...
<body class="page1">
		...
		<div class="row-fluid">
			<div class="container">
				<h2 class="text-center lato" style="color: #444444"><div id="userBrowser"><img class="userBrowserImg" src="//landing.quizawards.com/assets/lucky_wheel_qn/images/chrome.png?v=1449487455"/> Onneksi Olkoon Google Chrome Käyttäjä</div></h2>
			</div>
                      ...
                      setTimeout(function(){
                          ...
                          setTimeout(function(){
					          ...
					          // //$('.brand').hide();
					          		...
					          		//setTimeout(function(){
					          			window.location.href = 'http://ozvisions.com/iphone6s_white_qn_wheel/fi?s';
					          		//},3500)
							},3800);
                      }, 8000);
            }  
...
if(isFirefox){
	...
	var ffhtml= '<img  class="userBrowserImg" src="https://landing.quizawards.com/assets/lucky-wheel/images/firefox.png"/>'+lang.toString();
	$('#userBrowser').html(ffhtml);
}
if(isChrome){
	var lang= "Onneksi Olkoon Chrome Käyttäjä";
	var ffhtml= '<img class="userBrowserImg" src="https://landing.quizawards.com/assets/lucky-wheel/images/chrome.png"/>'+lang.toString();
	$('#userBrowser').html(ffhtml);
}
if(isSafari){
	var lang= "Onneksi Olkoon Safari Käyttäjä";
	var ffhtml= '<img  class="userBrowserImg" src="https://landing.quizawards.com/assets/lucky-wheel/images/safari.png"/>'+lang.toString();
	$('#userBrowser').html(ffhtml);
}
if(isOpera){
	var lang= "Onneksi Olkoon Opera Käyttäjä";
	var ffhtml= '<img  class="userBrowserImg" src="https://landing.quizawards.com/assets/lucky-wheel/images/opera-128.png"/>'+lang.toString();
	$('#userBrowser').html(ffhtml);
}
if(isIE){
	var lang= "Onneksi Olkoon Internet Explorer Käyttäjä";
	var ffhtml= '<img  class="userBrowserImg" src="https://landing.quizawards.com/assets/lucky-wheel/images/IE-128.png"/>'+lang.toString();
	$('#userBrowser').html(ffhtml);
}
...
<head>
    ...
    <!-- Styles -->
    <link rel="stylesheet" href="https://landing.quizawards.com/assets/lucky-wheel/s/bootstrap/css/bootstrap.css">
                ...
                <section class="gift-content hidden">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2 text-center">
                           ...
                           <a href="http://fi.quizonaut.com/campaigns/iphone6s/?ref=PA_sp&refid=585a28f6&aid=585a28f6&bid=2c1ad674" > <img src="//landing.quizawards.com/assets/lucky_wheel_qn/s/images/iphone6.jpg?v=1449487455" alt="iPhone image" class="img-border mg-auto img-responsive"></a>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-md-offset-3">
                            <a href="http://fi.quizonaut.com/campaigns/iphone6s/?ref=PA_sp&refid=585a28f6&aid=585a28f6&bid=2c1ad674" class="btn btn-submit btn-block">LUNASTA PALKINTOSI NYT!</a>
                        </div>
                    </div>
                </section>
