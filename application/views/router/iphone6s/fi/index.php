						...
						<div class="form-content col-xs-12">
							...
							<div class="accept-terms">
								<div class="form-bottom">
									<div class="checkbox">
										<label><input type="checkbox" name="cgu" class="checkname" value="1" required="required" checked="checked"> Hyväksyn  <a href="http://ozvisions.com/iphone6s/au/terms.php" target="_BLANK">Käyttöehdot</a></label>
									</div>
								</div>
							</div>
							</div>
		...
		function apiRun(form){
			...
			$.ajax({
				...
				success: function(resp){
					if(resp){
						window.location.href="http://ozvisions.com/iphone6s/fi/buffer.php";
					}else{
