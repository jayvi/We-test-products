			...
			<div class="row">
				...
				<div class="col-xs-12 col-md-8">
					<div class="iphone-price-tag">
						...
						<img src="http://ozvisions.com/iphone6s/uk/uk.png"/>
					</div>
						...
						<div class="form-content col-xs-12">
							...
							<div class="accept-terms">
								<div class="form-bottom">
									<div class="checkbox">
										<label><input type="checkbox" name="cgu" class="checkname" value="1" required="required" checked="checked"> I Accept  <a href="http://ozvisions.com/iphone6s/uk/terms.php" target="_BLANK">Terms & Conditions</a></label>
									</div>
								</div>
							</div>
							</div>
		...
		function apiRun(form){
			...
			$.ajax({
				...
				success: function(resp){
					if(resp){
						window.location.href="http://ozvisions.com/iphone6s/uk/buffer.php";
					}else{
