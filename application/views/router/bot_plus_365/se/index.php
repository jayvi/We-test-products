								...
								<div class="formBackground">
									...
									<div class="questions">
										...
										<div class="rowproducts">
											<a href="<?php echo $buttonURL?>"  border="0"><div class="clickmea previewImg" style="background-image: url('<?php echo base_url()?>assets/bot_plus_365/bmap_se.png');"></div></a>
...
önskade färdigheter för att börja arbeta.<br/>
				...
				<img src="<?php echo base_url('assets/bot_plus_365/pmax_se.png')?>" style="padding:4em 0;" class="lady"/>
			</div><!--ladyText-->
			...
			<div class="testWrapper">
				<div class="testimonials">
					...
					<div class="test">
						...
						<p>
							 Deponeras 2500 Kr. @<strong>botplus365</strong> med verifierad handlare systemet nu min
						</p>
