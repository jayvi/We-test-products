	...
	<body>
		<nav class="navbar navbar-inverse " >
			<div class="container-fluid">
				<div class="wrapper">
					<h1><big>Vennligst svar ærlig så vi kan være sikre på at du er den perfekte matchen for stillingen.</big></h1>
				...
				<div class="container-fluid mainContainer">
								...
								<div class="formBackground">
									...
									<div class="questions">
										<div type="button" name="counter" id="counter" style="float: left; margin-top: 15px; display: none; cursor: default; color: rgb(255, 255, 255); background-color: rgb(70, 98, 158);" class="btn btn-lg btn-block">
											Spørsmål <span id="numRight">1</span> av <span id="numQuestions">4</span>
										</div>
										...
										<div class="qq1">
											<span id="question" style="font-size:21px;color:#6e6e6e;padding: 20px 0px 0px 0px;float: left; width: 100%;">Er du rask til å ta avgjørelser?</span>
										...
										<div class="qq2" style="display: none">
											<span id="question" style="font-size:21px;color:#6e6e6e;padding: 20px 0px 0px 0px;float: left; width: 100%;">Har du jobbet hjemmefra før?</span>
											<div class="radio" style="float: left; clear: both; width: 100%;">
										...
										<div class="qq3" style="display: none">
											<span id="question" style="font-size:21px;color:#6e6e6e;padding: 20px 0px 0px 0px;float: left; width: 100%;">Velg din favoritt.</span>
											<div class="radio" style="float: left; clear: both; width: 100%;">
										...
										<div class="qq4" style="display: none">
											<span id="question" style="font-size:21px;color:#6e6e6e;padding: 20px 0px 0px 0px;float: left; width: 100%;">Har du muligheten til å begynne å jobbe i dag?</span>
											<div class="radio" style="float: left; clear: both; width: 100%;">
										...
										<div class="rowproducts">
											...
											<input type="button" style="    display: -moz-inline-box; width: 100%;border: 0px;background: linear-gradient(#ec6030,#e55b2b,#f07e56) ;border-radius: 5px;outline: none;display:inline-block; padding: 15px 0px;max-width: 249px;clear: both;margin:20px 0px 20px 12%; float: none;" value="Klikk her" class="clickmep"/>
											</a>
											<div class="pdesc">
												<p style="text-align: center;">
													 Du har blitt forhåndsgodkjent til å bli med basert på dine svar.
													<br />
													<br />
													Vennligst fyll ut informasjonen og begynn på et bedre liv i dag.	
												</p>
									...
									<div class="underAnswers">
										...
										<p>
											 Vennligst svar ærlig så vi kan være sikre på at du er den perfekte matchen for stillingen.
										</p>
										<p></p>
										<p>
											Husk, dette er en personalitets-test for stillingen.
										</p>
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div id="comments" style="display: none;">
							...
							<p>
								<span style="font-size:14px"><span style="font-family:arial,helvetica,sans-serif">Hei,
										<br />
										<br />
										Vi ønsker deg velkommen til den første delen av din nye karierre.	
										<br />
										<br />
										 Du vil nå gjennomgå en kjapp personalitets-test 
										<br />
										for å sikre at du vil passe inn og ha den ønskede 
										<br />
										kompetansen for å starte å jobbe
										<br />
										<br />
										 Vær så ærlig som mulig.</span></span>
							</p>
		...
		<div class="wrapper">
			...
			<div class="testWrapper">
				<div class="testimonials">
					<h3>Siste kommentar av vår nyeste ansatte.</h3>
					...
					<div class="test">
						...
						<p>
							Satte inn  1900 Kr. @<strong>britmethod</strong>&nbsp; med det verifiserte trader-systemet  og nå er 
						</p>

						<p>
						kontoen på over	 245.000 Kr. innen en uke #Lovethis #millionairestatus
						</p>
						</p>
					</div>
					<!--
