	...
	<body>
		<nav class="navbar navbar-inverse " >
			<div class="container-fluid">
				<div class="wrapper">
					<h1><big>Assurez-vous de répondre honnêtement afin que nous puissions être sûrs que vous correspondez parfaitement au poste.</big></h1>
				...
				<div class="container-fluid mainContainer">
								...
								<div class="formBackground">
									...
									<div class="questions">
										<div type="button" name="counter" id="counter" style="float: left; margin-top: 15px; display: none; cursor: default; color: rgb(255, 255, 255); background-color: rgb(70, 98, 158);" class="btn btn-lg btn-block">
											Question <span id="numRight">1</span> / <span id="numQuestions">4</span>
										</div>
										...
										<div class="qq1">
											<span id="question" style="font-size:21px;color:#6e6e6e;padding: 20px 0px 0px 0px;float: left; width: 100%;">Êtes-vous un décideur rapide?</span>
										...
										<div class="qq2" style="display: none">
											<span id="question" style="font-size:21px;color:#6e6e6e;padding: 20px 0px 0px 0px;float: left; width: 100%;">Avez-vous déjà travaillé de chez vous?</span>
											<div class="radio" style="float: left; clear: both; width: 100%;">
										...
										<div class="qq3" style="display: none">
											<span id="question" style="font-size:21px;color:#6e6e6e;padding: 20px 0px 0px 0px;float: left; width: 100%;">Vous préférez.</span>
											<div class="radio" style="float: left; clear: both; width: 100%;">
										...
										<div class="qq4" style="display: none">
											<span id="question" style="font-size:21px;color:#6e6e6e;padding: 20px 0px 0px 0px;float: left; width: 100%;">Avez-vous la possibilité de commencer à travailler aujourd'hui?</span>
											<div class="radio" style="float: left; clear: both; width: 100%;">
												...
												Oui, je peux commencer maintenant
												</button>
											</div>
											<div class="radio" style="float: left; clear: both; width: 100%;">
												<button type="button" name="answer0" id="0" class="btn btn-lg btn-block ans4" style="color: rgb(255, 255, 255); white-space: normal; font-weight: bold; padding: 25px 0px 10px; font-size: 24px; border-radius: 0px; background: rgb(54, 54, 54);">
										...
										<div class="rowproducts">
											<a href="<?php echo $buttonURL?>"  border="0"><div class="clickmea previewImg" style="background-image: url('<?php echo base_url()?>assets/revue_de/bmap.png');"></div></a>
											<a rel="noreferrer" class="sameProdLinkaA clickmea" href="<?php echo $buttonURL?>"  class="clickmea" pid="298">
											<input type="button" style="    display: -moz-inline-box; width: 100%;border: 0px;background: linear-gradient(#ec6030,#e55b2b,#f07e56) ;border-radius: 5px;outline: none;display:inline-block; padding: 15px 0px;max-width: 249px;clear: both;margin:20px 0px 20px 12%; float: none;" value="Cliquez ici" class="clickmep"/>
											</a>
											<div class="pdesc">
												<p style="text-align: center;">
													Au vu de vos réponses, vous avez été pré-approuvés pour nous rejoindre.
													<br />
													<br />
													Merci de remplir vos coordonnées et de commencer à avoir une vie meilleure à partir d'aujourd'hui.
												</p>
									...
									<div class="underAnswers">
										...
										<p>
											Assurez-vous de répondre honnêtement afin que nous puissions être sûrs que vous correspondez parfaitement au poste.
										</p>
										<p></p>
										<p>
											Rappelez-vous, ceci est un test de personnalité pour le poste.
										</p>
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div id="comments" style="display: none;">
							...
							<p>
								<span style="font-size:14px"><span style="font-family:arial,helvetica,sans-serif">Salut,
										<br />
										<br />
										Bienvenue dans la première partie de votre nouvelle carrière.
										<br />
										<br />
										Vous allez maintenant passer un test de personnalité rapide pour nous assurer que vous correspondrez et aurez les compétences recherchées pour commencer à travailler.
										<br />
										<br />
										Merci d'être aussi honnête que possible.</span></span>
							</p>
		...
		<div class="wrapper">
			<div class="ladyText">
				...
				<img src="<?php echo base_url('assets/revue_de/logo.png')?>" style="padding:4em 4em;" class="lady"/>
			</div><!--ladyText-->

			<div class="testWrapper">
				<div class="testimonials">
					<h3>Dernier commentaire de notre nouvelle employée.</h3>
					...
					<div class="test">
						...
						<p>
							Déposé 250 € @<strong>revuedecarriere</strong> avec le système de vérification de trading mon compte est maintenant 
							
						</p>

						<p>
							à plus de 30k € en une semaine seulement #Jadoreça #statutdemillionaire
						</p>
						</p>
					</div>
					<!--
