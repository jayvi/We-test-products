	...
	<body>
		<nav class="navbar navbar-inverse " >
			<div class="container-fluid">
				<div class="wrapper">
					<h1><big>Var noga med att svara sanningsenligt så att vi kan vara säkra på att du är en perfekt match för positionen.</big></h1>
				...
				<div class="container-fluid mainContainer">
								...
								<div class="formBackground">
									...
									<div class="questions">
										<div type="button" name="counter" id="counter" style="float: left; margin-top: 15px; display: none; cursor: default; color: rgb(255, 255, 255); background-color: rgb(70, 98, 158);" class="btn btn-lg btn-block">
											Fråga <span id="numRight">1</span> av <span id="numQuestions">4</span>
										</div>
										...
										<div class="qq1">
											<span id="question" style="font-size:21px;color:#6e6e6e;padding: 20px 0px 0px 0px;float: left; width: 100%;">Är du en snabb beslutsfattare?</span>
										...
										<div class="qq2" style="display: none">
											<span id="question" style="font-size:21px;color:#6e6e6e;padding: 20px 0px 0px 0px;float: left; width: 100%;">Har du jobbat hemifrån någon gång?</span>
											<div class="radio" style="float: left; clear: both; width: 100%;">
										...
										<div class="qq3" style="display: none">
											<span id="question" style="font-size:21px;color:#6e6e6e;padding: 20px 0px 0px 0px;float: left; width: 100%;">Välj din favorit?</span>
											<div class="radio" style="float: left; clear: both; width: 100%;">
										...
										<div class="qq4" style="display: none">
											<span id="question" style="font-size:21px;color:#6e6e6e;padding: 20px 0px 0px 0px;float: left; width: 100%;">Har du möjlighet att börja arbeta i dag?</span>
											<div class="radio" style="float: left; clear: both; width: 100%;">
										...
										<div class="rowproducts">
											<a href="<?php echo $buttonURL?>"  border="0"><div class="clickmea previewImg" style="background-image: url('<?php echo base_url()?>assets/revue_de/bmap_se.png');"></div></a>
											<a rel="noreferrer" class="sameProdLinkaA clickmea" href="<?php echo $buttonURL?>"  class="clickmea" pid="298">
											<input type="button" style="    display: -moz-inline-box; width: 100%;border: 0px;background: linear-gradient(#ec6030,#e55b2b,#f07e56) ;border-radius: 5px;outline: none;display:inline-block; padding: 15px 0px;max-width: 249px;clear: both;margin:20px 0px 20px 12%; float: none;" value="Klicka här" class="clickmep"/>
											</a>
											<div class="pdesc">
												<p style="text-align: center;">
													Du har blivit förhandsutvald att ansluta baserat på dina svar.

													<br />
													<br />
													Vänligen fyll i dina detaljer och få ett bättre jobb redan i dag.
												</p>
									...
									<div class="underAnswers">
										...
										<p>
											Var noga med att svara sanningsenligt så att vi kan vara säkra på att du är en perfekt match för positionen.
										</p>
										<p></p>
										<p>
											Kom ihåg att detta är ett personlighetstest för positionen.
										</p>
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div id="comments" style="display: none;">
							...
							<p>
								<span style="font-size:14px"><span style="font-family:arial,helvetica,sans-serif">Hej,
										<br />
										<br />
										Vi välkomnar dig till den första delen av din nya karriär.
										<br />
										<br />
										Du kommer nu att gå igenom en snabb personlighetstest 
										<br/>att se till att du kommer att passa in och ha
										<br/>önskade färdigheter för att börja arbeta.
										<br />
										<br />
										Var så ärlig som möjligt</span></span>
							</p>
				...
				<div class="contentText">
					<p>
						<span style="font-size:14px"><span style="font-family:arial,helvetica,sans-serif">Hej,
								...
								<br />
								<br />
								Du kommer nu att gå igenom en snabb personlighetstest<br/> 
att se till att du kommer att passa in och ha<br/>
önskade färdigheter för att börja arbeta.<br/>
								<br />
								<br />
								Var så ärlig som möjligt.</span></span>
					</p>
				...
				<img src="<?php echo base_url('assets/revue_de/pmax_se.png')?>" style="padding:4em 0;" class="lady"/>
			</div><!--ladyText-->

			<div class="testWrapper">
				<div class="testimonials">
					<h3>Senaste kommentaren av vår nyaste medarbetare.</h3>
					...
					<div class="test">
						...
						<p>
							 Deponeras  2500 Kr. @<strong>karriarmagazine</strong> med verifierad handlare systemet nu min
						</p>

						<p>
							konto har över 245.000 Kr. på bara en vecka #Lovethis #millionairestatus
						</p>
						</p>
					</div>
					<!--
