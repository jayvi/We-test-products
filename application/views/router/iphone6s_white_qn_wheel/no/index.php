...
<body class="page1">
		...
		<div class="row-fluid">
			<div class="container">
				<h2 class="text-center lato" style="color: #444444"><div id="userBrowser"><img class="userBrowserImg" src="//landing.quizawards.com/assets/lucky_wheel_qn/images/chrome.png?v=1449487455"/> Gratulerer Google Chrome Bruker</div></h2>
			</div>
                      ...
                      setTimeout(function(){
                          ...
                          setTimeout(function(){
					          ...
					          // //$('.brand').hide();
					          		...
					          		//setTimeout(function(){
					          			window.location.href = 'http://wetestproducts.com/iphone6s_white_qn_wheel/no?s';
					          		//},3500)
							},3800);
                      }, 8000);
            }  
                ...
                <section class="gift-content hidden">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2 text-center">
                           ...
                           <a href="http://no.quizonaut.com/campaigns/iphone6s/?ref=PA_sp&refid=585a28f6&aid=585a28f6&bid=b7eb982c" > <img src="//landing.quizawards.com/assets/lucky_wheel_qn/s/images/iphone6.jpg?v=1449487455" alt="iPhone image" class="img-border mg-auto img-responsive"></a>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-md-offset-3">
                            <a href="http://no.quizonaut.com/campaigns/iphone6s/?ref=PA_sp&refid=585a28f6&aid=585a28f6&bid=b7eb982c" class="btn btn-submit btn-block">Hent gaven din nå!</a>
                        </div>
                    </div>
                </section>
