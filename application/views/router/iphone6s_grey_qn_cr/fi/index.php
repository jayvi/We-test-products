...
<html>
	...
	<body>
		...
		<div class="content">
			...
			<div class="main-content flag" style="    background: url(../assets/images/flag-fi.png) #fff no-repeat 98% 20px;" id="content1">
				<h1>TESTAA & PIDÄ</h1>
			...
			<div class="main-content" id="content3">
				...
				<p class="loading">
					<a onclick="PreventExitPop = false;" href="http://fi.quizonaut.com/campaigns/iphone6s/?ref=PA_sp2&refid=34c874b1&aid=34c874b1&bid=2c1ad674"><img src="../assets/images/iphone6.png"></a>
				</p>
				<a href="http://fi.quizonaut.com/campaigns/iphone6s/?ref=PA_sp2&refid=34c874b1&aid=34c874b1&bid=2c1ad674" onclick="PreventExitPop = false;" class="claim">
				<div class="button2">
					Lunasta Nyt
				</div></a>
			...
			<div class="main-content">
				...
				<div class="comments">
					...
					<div class="comment-status">
						<span>Tykkää · Reply · <img src="../assets/images/like.png" width="15px" height="15px"></img>87</span> ·
						<script type="text/javascript">
				...
				<div class="comments">
					...
					<div class="clr"></div>
					<div class="comment-status">
						<span>Tykkää · Reply · <img src="../assets/images/like.png" width="15px" height="15px"></img>54</span> ·
						<script type="text/javascript">
							document.write(get_date(0));
						</script>
					</div>
				...
				<div class="comments">
					...
					<div class="clr"></div>
					<div class="comment-status">
						<span>Tykkää · Reply · <img src="../assets/images/like.png" width="15px" height="15px"></img>10</span> ·
						<script type="text/javascript">
							document.write(get_date(0));
						</script>
					</div>
				...
				<div class="comments">
					...
					<div class="clr"></div>
					<div class="comment-status">
						<span>Tykkää · Reply · <img src="../assets/images/like.png" width="15px" height="15px"></img>45</span> ·
						<script type="text/javascript">
				...
				<div class="comments">
					...
					<div class="clr"></div>
					<div class="comment-status">
						<span>Tykkää · Reply · <img src="../assets/images/like.png" width="15px" height="15px"></img>3</span> -
						<script type="text/javascript">
