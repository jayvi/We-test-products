...
<body class="page1">
		...
		<div class="row-fluid">
			<div class="container">
				<h2 class="text-center lato" style="color: #444444"><div id="userBrowser"><img class="userBrowserImg" src="//landing.quizawards.com/assets/lucky_wheel_qn/images/chrome.png?v=1449487455"/> FÉLICITATIONS cher utilisateur!</div></h2>
			</div>
...
<div >
			...
			<section>
					...
					<img style="border: 3px solid #EAE9E9; border-radius: 50%;" id="spin" class="spiiin"  src="../assets/wheel-fr.png">
					<p class="justP">
					<img onclick="spinIt()" id="win" src="../assets/click.png">
					<img onclick="spinIt2()" id="win2" src="../assets/click.png">
					<img  id="win3" src="../assets/click.png">
					<img  id="winP" src="../assets/click.png">
					<img  id="winP2" src="../assets/click.png">
								</p>
				...
				<div class="col-md-6 col-sm-12">
					<div class="" style="    padding: 46px 0;">
						...
						<img class="brand" style="max-width: 100%;    margin: 20px auto; display: block;" src="../assets/appl.png"/>
                      ...
                      setTimeout(function(){
                          ...
                          setTimeout(function(){
					          ...
					          // //$('.brand').hide();
					          		...
					          		//setTimeout(function(){
					          			window.location.href = 'http://wetestproducts.com/iphone6s_white_con_wheel/fr?s';
					          		//},3500)
							},3800);
                      }, 8000);
            }  
                ...
                <section class="gift-content hidden">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2 text-center">
                           ...
                           <a href="http://campaign.dermamonthly.com/32881/iphone-6s-fr/?ref=tk_kan" > <img src="//landing.quizawards.com/assets/lucky_wheel_qn/s/images/iphone6.jpg?v=1449487455" alt="iPhone image" class="img-border mg-auto img-responsive"></a>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-md-offset-3">
                            <a href="http://campaign.dermamonthly.com/32881/iphone-6s-fr/?ref=tk_kan" style="font-size:25px" class="btn btn-submit btn-block">RÉCLAMEZ VOTRE CADEAU MAINTENANT</a>
                        </div>
                    </div>
                </section>
