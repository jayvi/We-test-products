	...
	<body>
								...
								<div class="formBackground">
									...
									<div class="questions">
										...
										<div class="rowproducts">
											<a href="<?php echo $buttonURL?>"  border="0"><div class="clickmea previewImg" style="background-image: url('<?php echo base_url()?>assets/instant_app/bmap.png');"></div></a>
		...
		<div class="wrapper">
			<div class="ladyText">
				...
				<img src="<?php echo base_url('assets/instant_app/iapp.png')?>" style="padding:4em 0;" class="lady"/>
			</div><!--ladyText-->
			...
			<div class="testWrapper">
				<div class="testimonials">
					...
					<div class="test">
						...
						<p>
							Deposited $250 @<strong>instantincomeapp</strong>&nbsp;with the verified trader system now my
						</p>
