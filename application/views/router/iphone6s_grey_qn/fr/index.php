...
header('Location: http://wetestproducts.com/iphone6s_grey_con/fr/');
exit();
?>
<!doctype html>
<html>
	...
	<body>
		...
		<div class="content">
			...
			<div class="main-content flag" style="    background: url(../assets/images/flag-fr.png) #fff no-repeat 98% 20px;" id="content1">
				<h1>TESTER & GARDER</h1>
			...
			<div class="main-content" id="content3">
				...
				<p class="loading">
					<a onclick="PreventExitPop = false;" href="http://fr.quizonaut.com/campaigns/iphone6s/?ref=PA_sp&refid=585a28f6&aid=585a28f6&bid=bb542a61<?php echo $ulbid;?>"><img src="../assets/images/iphone6.png"></a>
				</p>
				<a href="http://fr.quizonaut.com/campaigns/iphone6s/?ref=PA_sp&refid=585a28f6&aid=585a28f6&bid=bb542a61<?php echo $ulbid;?>" onclick="PreventExitPop = false;" class="claim">
					<!--http://fr.quizonaut.com/campaigns/iphone6s/?ref=PA_sp&refid=585a28f6&aid=585a28f6&bid=bb542a61-->
				<div class="button2">
			...
			<div class="main-content">
				...
				<div class="comments">
					...
					<div class="comment-status">
						<span>j'aime · Répondre · <img src="../assets/images/like.png" width="15px" height="15px"></img>87</span> ·
						<script type="text/javascript">
				...
				<div class="comments">
					...
					<div class="clr"></div>
					<div class="comment-status">
						<span>j'aime · Répondre · <img src="../assets/images/like.png" width="15px" height="15px"></img>54</span> ·
						<script type="text/javascript">
							document.write(get_date(0));
						</script>
					</div>
				...
				<div class="comments">
					...
					<div class="clr"></div>
					<div class="comment-status">
						<span>j'aime · Répondre · <img src="../assets/images/like.png" width="15px" height="15px"></img>10</span> ·
						<script type="text/javascript">
							document.write(get_date(0));
						</script>
					</div>
				...
				<div class="comments">
					...
					<div class="clr"></div>
					<div class="comment-status">
						<span>j'aime · Répondre · <img src="../assets/images/like.png" width="15px" height="15px"></img>45</span> ·
						<script type="text/javascript">
				...
				<div class="comments">
					...
					<div class="clr"></div>
					<div class="comment-status">
						<span>j'aime · Répondre · <img src="../assets/images/like.png" width="15px" height="15px"></img>3</span> -
						<script type="text/javascript">
