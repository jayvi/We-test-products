...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo base_url()?>assets/social_trader/bootstrap/css/bootstrap.css">
	<link href="<?php echo base_url()?>assets/social_trader/css/style.css" rel="stylesheet" />
	<link rel="stylesheet" href="<?php echo base_url()?>assets/social_trader/css/media.css" />
</head>
<body>
	<div id="wrapper">
		<div class="hero-section container uppercase">
			...
			<div id="questions">
				...
				<div id="final">
					...
					<div class="qnum clearfix">
						<div class="logo-box">
							<a href="#"><img src="<?php echo base_url()?>assets/social_trader/images/logo-sm.png" alt=""></a>
						</div>
						<div class="request">
		...
		<div class="comment-section container">
			...
			<div class="comment-block clearfix">
				<div class="employee">
					<img src="<?php echo base_url()?>assets/social_trader/images/user-img.png" alt="pic of employee">
				</div>
				<div class="comment">
	...
	<script src="<?php echo base_url()?>assets/social_trader/bootstrap/js/bootstrap.js"></script>
	<script type="text/javascript" src="<?php echo base_url()?>assets/social_trader/js/app.js"></script>
