...
<html lang="en">
	<head>
		<meta charset="UTF-8">
		<title>Oxford Method </title>
		<link media="all" type="text/css" rel="stylesheet" href="<?php echo base_url()?>assets/oxford/uk/css/backend.css">

		<link media="all" type="text/css" rel="stylesheet" href="<?php echo base_url()?>assets/oxford/uk/css/bootstrap.css">

		<script src="<?php echo base_url()?>assets/oxford/uk/js/jquery.js"></script>

		<script src="<?php echo base_url()?>assets/oxford/uk/js/bootstrap.js"></script>

		<link media="all" type="text/css" rel="stylesheet" href="<?php echo base_url()?>assets/oxford/uk/css/tpl_css/apple_christmass2.css">
		...
		<style>
			...
			.main {
				background: url('<?php echo base_url()?>assets/oxford/uk/uploads/20160302113206_map1.jpg') no-repeat;
				background-size: 100%;
				height: 818px;
				display: table;
				clear: both;
			...
			.bubble {
				background: url('<?php echo base_url()?>assets/oxford/uk/uploads/casino_funnel/buble.png') no-repeat;
				width: 346px;
				height: 192px;
				position: absolute;
				right: 11.5%;
			...
			@media screen and (max-width: 1024px) {
				.bubble {
					...
					top: 41%;
					left: 62%;
					background: url('<?php echo base_url()?>assets/oxford/uk/uploads/casino_funnel/buble-flip.png') no-repeat;
				}
			...
			@media screen and (max-width: 800px) {
				...
				.bubble {
					...
					height: 168px;
					position: relative;
					background: url('<?php echo base_url()?>assets/oxford/uk/uploads/casino_funnel/buble-flip-right.png') no-repeat;
					margin-left: 3%;
					margin-top: 5%;
					float: left;
				}
	...
	<body>
								...
								<div class="formBackground">
									...
									<div class="questions">
										...
										<div class="rowproducts">
											<a href="<?php echo $buttonURL?>"  border="0"><div class="clickmea previewImg" style="background-image: url('<?php echo base_url()?>assets/oxford/uk/uploads/tit.png');"></div></a>
		...
		<div class="wrapper">
			<div class="ladyText">
				...
				<img src="<?php echo base_url()?>assets/oxford/uk/uploads/tit.png" class="lady"/>
			</div><!--ladyText-->
			...
			<div class="testWrapper">
				<div class="testimonials">
					...
					<div class="test">
						<img src='<?php echo base_url()?>assets/oxford/uk/uploads/20160302120930_lydia.jpg'>
						<p>
						<p>
							Lydia:
						</p>
						...
						<p>
							Deposited  &pound;250 @<strong>oxfordmethod</strong>&nbsp;with the verified trader system now my
						</p>

						<p>
							account sits at over  &pound;30k in just a week #Lovethis #millionairestatus
						</p>
						</p>
					</div>
					<!--
