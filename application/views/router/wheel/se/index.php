...
<link href='https://fonts.googleapis.com/css?family=Open+Sans:400,600,700' rel='stylesheet' type='text/css'>	
	...
	<link rel="stylesheet" href="<?php echo base_url('assets/'.$options[0]['view'])?>/assets/css/style.css">
...
<body class="page1">
		...
		<div class="row-fluid">
			<div class="container">
				<h2 class="text-center lato" style="color: #444444"><div id="userBrowser"><img class="userBrowserImg" src="<?php echo base_url('assets/'.$options[0]['view'])?>/assets/images/chrome.png"/> Grattis Google Chrome användare</div></h2>
			</div>
                ...
                <section class="gift-content hidden">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-md-offset-3">
                            <a href="<?php echo $buttonURL?>" class="btn btn-submit btn-block">Hämta din gåva nu!</a>
                        </div>
                    </div>
                </section>
