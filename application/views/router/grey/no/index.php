			...
			<div class="main-content">
				...
				<div class="comments">
					...
					<div class="comment-status">
						<span>Lik · Reply · <img src="<?php echo base_url('assets/'.$options[0]['view'])?>/assets/images/like.png" width="15px" height="15px"></img>87</span> ·
						<script type="text/javascript">
				...
				<div class="comments">
					...
					<div class="clr"></div>
					<div class="comment-status">
						<span>Lik · Reply · <img src="<?php echo base_url('assets/'.$options[0]['view'])?>/assets/images/like.png" width="15px" height="15px"></img>54</span> ·
						<script type="text/javascript">
							document.write(get_date(0));
						</script>
					</div>
				...
				<div class="comments">
					...
					<div class="clr"></div>
					<div class="comment-status">
						<span>Lik · Reply · <img src="<?php echo base_url('assets/'.$options[0]['view'])?>/assets/images/like.png" width="15px" height="15px"></img>10</span> ·
						<script type="text/javascript">
							document.write(get_date(0));
						</script>
					</div>
				...
				<div class="comments">
					...
					<div class="clr"></div>
					<div class="comment-status">
						<span>Lik · Reply · <img src="<?php echo base_url('assets/'.$options[0]['view'])?>/assets/images/like.png" width="15px" height="15px"></img>45</span> ·
						<script type="text/javascript">
				...
				<div class="comments">
					...
					<div class="clr"></div>
					<div class="comment-status">
						<span>Lik · Reply · <img src="<?php echo base_url('assets/'.$options[0]['view'])?>/assets/images/like.png" width="15px" height="15px"></img>3</span> -
						<script type="text/javascript">
...
<p style="text-align: center" class="small text-right"> <small><a style="color:black;text-decoration:none" target="_blank" href="http://ozvisions.com/iphone6s_grey_01/no/terms.php">Terms & Conditions</a></small></p>
