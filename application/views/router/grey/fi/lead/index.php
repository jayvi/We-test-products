	...
	<body>
		...
		<div class="content">
			...
			<div class="main-content" id="content3">
				...
				<p class="loading">
					<a onclick="PreventExitPop = false;" href="http://ozvisions.com/iphone6s/fi/"><img src="../assets/images/iphone6.png"></a>
				</p>
				<a href="http://ozvisions.com/iphone6s/fi/" onclick="PreventExitPop = false;" class="claim">
				<div class="button2">
					Lunasta Nyt
				</div></a>
